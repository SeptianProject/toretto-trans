  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Sewa Mobil",
        item: "https://toretto.biz.id/sewa-mobil",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: vehicle.name,
        item: `https://toretto.biz.id/sewa-mobil/${vehicle.id}`,
      },
    ],
  };
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <nav className="text-sm text-amber-300">
        <Link href="/">Home</Link> / <Link href="/sewa-mobil">Sewa Mobil</Link>{" "}
