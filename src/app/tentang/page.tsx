...
export const metadata: Metadata = {
  title: "Tentang Toretto Trans",
  description:
    "Profil Toretto Trans sebagai penyedia Tour Travel Surabaya dan Sewa Bis Surabaya dengan fokus premium dan scalable.",
  openGraph: {
    title: "Tentang Toretto Trans",
    description:
      "Pelajari visi, pengalaman, dan pendekatan layanan Toretto Trans.",
    url: "/tentang",
    type: "website",
  },
};
    ...
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      <section className="rounded-[2rem] border border-white/10 bg-white/5 p-8">
        ...
        <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
          Toretto Trans fokus pada layanan perjalanan yang premium untuk
