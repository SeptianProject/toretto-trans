...
export const mockTestimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment:
      "Pelayanan Toretto Trans sangat profesional! Trip ke Bromo kemarin sangat berkesan. Guide-nya ramah, akomodasi oke, dan harga sangat terjangkau. Pasti balik lagi!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Pertama kali pakai jasa tour, dan Toretto Trans tidak mengecewakan. Itinerary-nya simple dan tidak ribet. Sangat recommended untuk keluarga!",
...
export const mockVehicles: Vehicle[] = [
  {
    ...
    features: ["AC", "Full Tank", "Driver", "Asuransi"],
    available: true,
  },
  {
    id: "2",
    ...
    features: ["AC", "Full Tank", "Driver", "Asuransi", "Audio System"],
    available: true,
  },
  {
    id: "3",
    ...
    capacity: 35,
    pricePerDay: 2500000,
    image: "/images/vehicles/bus-medium.jpg",
    features: [
      "AC",
      "Full Tank",
      "Driver",
  ...
  },
  {
    id: "4",
    type: "bis",
    name: "Bus Besar (55 seat)",
    capacity: 55,
    pricePerDay: 3800000,
    image: "/images/vehicles/bus-besar.jpg",
    features: [
      "AC",
      "Full Tank",
      "Driver",
